...
haribote.img : haribote/ipl09.bin haribote/haribote.sys Makefile \
		...
		appreader/appreader.hrb winhelo2/winhelo2.hrb winhelo3/winhelo3.hrb \
		...
		notrec/notrec.hrb bball/bball.hrb invader/invader.hrb userr/userr.hrb userw/userw.hrb \
